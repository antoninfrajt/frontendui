...
// import { InsertSemesterButton } from "./CUDButtons/InsertSemesterButton";
// import { UpdateSemesterButton } from "./CUDButtons/UpdateSemesterButton";
// import { DeleteSemesterButton } from "./CUDButtons/DeleteSemesterButton";
import { useAsyncAction } from "@hrbolek/uoisfrontend-gql-shared";
import { SemesterInsertAsyncAction, SemesterUpdateAsyncAction, SemesterDeleteAsyncAction } from "../Queries";
...
export const SemesterButton = ({ operation, children, semester, onDone = () => {}, ...props }) => {
    const operationConfig = {
        C: {
            ...
            dialogTitle: "Vložit nový semestr",
            loadingMsg: "Vkládám nový semestr",
            renderContent: () => <SemesterMediumEditableContent semester={semester} />,
        },
        U: {
            asyncAction: SemesterUpdateAsyncAction,
            dialogTitle: "Upravit semestr",
            loadingMsg: "Ukládám semestr",
            renderContent: () => <SemesterMediumEditableContent semester={semester} />,
        },
        D: {
            asyncAction: SemesterDeleteAsyncAction,
            dialogTitle: "Odebrat semestr",
            loadingMsg: "Odstraňuji semestr",
            renderContent: () => (
                <h2>
                    {semester?.order}
                </h2>
